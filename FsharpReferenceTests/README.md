This folder will contain projects and experiments regarding [F# reference page](https://docs.microsoft.com/en-us/dotnet/fsharp/language-reference/
)

Original of this page [here](https://github.com/dotnet/docs/blob/main/docs/fsharp/language-reference/index.md)

I will rewrite all links of this page to links to my code.  
It will be something like a learning roadmap for me.
